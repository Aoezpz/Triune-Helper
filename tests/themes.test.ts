 ...
 * list and the stylesheet agree, and that the reserved colors - status, trio
...
describe('themes', () => {
  ...
  it('gives every scheme a name, a note and three swatch colors', () => {
  ...
  /**
   * The reserved colors. --good, --bad, --warn and the three trio slots are
   ...
   */
  it('keeps every accent clear of the reserved colors', () => {
